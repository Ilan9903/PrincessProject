      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="font-bold text-gray-800 text-sm">Installer l'application</h4>
            <p className="text-gray-600 text-xs mt-1 leading-relaxed">
              {platform === 'ios' ? (
                <>Appuie sur <span className="inline-block bg-gray-100 p-1 rounded">share</span> puis sur <b>"Sur l'écran d'accueil"</b> pour l'avoir comme une vraie app !</>
              ) : (
