  ...
  const envelopes = [
    {
      ...
      image: "https://media.giphy.com/media/3oEdv4hwWTzBhWvaU0/giphy.gif" // Câlin virtuel
    },
    {
      id: 2,
      ...
      image: "https://media.giphy.com/media/VbawWIGNtWAu79qQKS/giphy.gif" // Bisous
    },
    {
      id: 3,
      ...
      image: "https://media.giphy.com/media/l4pTdcifPZLpDjL1e/giphy.gif" // Chien désolé
    },
    {
      id: 4,
      ...
      image: "https://media.giphy.com/media/kaq6GnxDlJaBq/giphy.gif" // Minions ou truc drôle
    },
    {
      id: 5,
      ...
      image: "https://media.giphy.com/media/26BRv0ThflsHCqDrG/giphy.gif" // Coeur
    },
    {
      id: 6,
      ...
      image: "https://media.giphy.com/media/1xVbRS6j52YSzp9E7Q/giphy.gif" // High five
    },
  ];
  ...
  return (
    <div className="fixed inset-0 bg-pink-50 flex flex-col items-center justify-start p-6 overflow-y-auto font-['Playfair_Display']">
      ...
      <div className="z-10 w-full max-w-2xl mt-12 mb-8 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400 mb-4 animate-fade-in-up">
          Ouvrir quand... 💌
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full px-2">
          {envelopes.map((env) => (
            <button
              ...
              className={`group relative p-6 rounded-2xl border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 active:scale-95 text-left overflow-hidden ${env.color} bg-white`}
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-8 relative animate-fade-in-up border-4 border-pink-100">
            ...
            <button 
              ...
              className="absolute top-4 right-4 text-gray-400 hover:text-red-500 text-xl w-8 h-8 flex items-center justify-center rounded-full hover:bg-red-50 transition-colors"
            >
              ✕
            </button>
            ...
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <button 
                onClick={() => setSelectedEnvelope(null)}
                className="bg-pink-500 text-white px-6 py-2 rounded-full font-bold shadow-md hover:bg-pink-600 transition-colors"
              >
                Ça va mieux ❤️
              </button>
            </div>
